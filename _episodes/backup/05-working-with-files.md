...
don't have permission to carry out the ability encoded by that space (this is the space where `x` or executable ability is stored, more about this in [a different lesson](http://www.datacarpentry.org/shell-genomics/05-writing-scripts/)).
